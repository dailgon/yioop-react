                                    ...
                                    <div className="col s12 m10 offset-m1 l7" style={{paddingTop: "10px", paddingBottom: "10px"}}>
                                        <form className="navForm z-depth-1" style={{height: "48px"}} autoComplete="off">
                                            <div className="input-field">
                                                <input className="white" type="search" name="q" placeholder="Enter Search Query here" required style={{height: "48px"}} />
                                ...
                                <div className="row" style={{margin: "0px"}}>
                                    ...
                                    <div className="col s12 m6" id="leftTab" style={{padding: "0px",paddingLeft: "10px"}}>
                                        <ul className="tabs tabs-transparent">
                                            <li className="tab active"><a className="active grey-text text-darken-1" style={{fontWeight: "bold"}}>Web</a></li>
                                            <li className="tab"><a className="grey-text text-darken-1" style={{fontWeight: "bold"}}>Images</a></li>
                                            <li className="tab"><a className="grey-text text-darken-1" style={{fontWeight: "bold"}}>Videos</a></li>
                                            <li className="tab"><a className="grey-text text-darken-1" style={{fontWeight: "bold"}}>News</a></li>
                                        </ul>
                                    </div>
